...
export default function ManageProductPage() {
  ...
  return (
    <Container>
      <Toaster />
        <h1 className="text-4xl  font-extrabold text-center mb-8 bg-linear-to-r from-indigo-600 to-purple-600 text-transparent bg-clip-text">
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <div className="flex justify-center gap-3">
                      <button
                        onClick={() => router.push(`/product/update/${p._id}`)}
                      ...
                      >
                        <RiDeleteBin5Line className="text-red-600" size={20} />
                      </button>
                    </div>
                  </td>
                </tr>
